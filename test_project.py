...
def test_save_smallest_audio_stream():
    ...
    assert project.save_smallest_audio_stream(
        ytObject, "./media", "fN-_j1yOXCE.mp3"
    ).endswith("fN-_j1yOXCE.mp3")


def test_cut_file():
    ytObject = project.get_video("https://www.youtube.com/watch?v=WbzNRTTrX0g")
    download_full_path = project.save_smallest_audio_stream(
        ytObject, "./media", "WbzNRTTrX0g.mp3"
    )
...
def test_speech_to_text():
    ...
    ytObject = project.get_video("https://www.youtube.com/watch?v=TV7Dj8lch4k")
    download_full_path = project.save_smallest_audio_stream(
        ytObject, "./media", "TV7Dj8lch4k.mp3"
    )
...
def test_cut_text():
    assert (
        project.cut_text("This is a test of the cut_text function", 4096)
        == "This is a test of the cut_text function"
    )
