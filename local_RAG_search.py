...
def get_relevant_context(rewritten_input, vault_embeddings, vault_content, top_k=3):
    """Get relevant context from the vault based on the user input. Credit to AllAboutAI for original code"""
...
def ollama_chat(user_input, system_message, vault_embeddings, vault_content, ollama_model, conversation_history):
    """Interact with the Ollama model to generate a response. Credit to AllAboutAI for original code"""
